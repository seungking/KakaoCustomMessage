...
import kotlinx.android.synthetic.main.fragment_location_param.*
import java.io.File
...
class LocationParamFragment : Fragment() {
...
//원하는 퍼미션을 이곳에 추가하면 된다.
    ...
    override fun onCreateView(
        ...
        mview = inflater.inflate(R.layout.fragment_location_param, container, false)
        ...
        photoImgRemoveBtn?.setOnClickListener {
            (activity as CreateLocationActivity).imageBitmap = null
            (activity as CreateLocationActivity).imageURL = null
        ...
        txtEditTitleBody?.addTextChangedListener {
            (activity as CreateLocationActivity).title = txtEditTitleBody.text.toString()
        }
        val txtEditTextBody = mview?.findViewById<EditText>(R.id.txtEditTextBody)
        txtEditTextBody?.addTextChangedListener {
            (activity as CreateLocationActivity).text = txtEditTextBody.text.toString()
        }
        ...
        txtEditTextBodyBodyLink?.addTextChangedListener {
            (activity as CreateLocationActivity).button1linkLink =
        ...
        txtEditTextBodyBodyLink1?.addTextChangedListener {
            (activity as CreateLocationActivity).button2linkLink =
        ...
        txtEditTextBodyBody?.addTextChangedListener {
            (activity as CreateLocationActivity).button1link = txtEditTextBodyBody.text.toString()
        }
        ...
        txtEditTextBodyBody1?.addTextChangedListener {
            (activity as CreateLocationActivity).button2link = txtEditTextBodyBody1.text.toString()
        }

        val checkboxButton1 = mview?.findViewById<CheckBox>(R.id.checkboxButton1)
        checkboxButton1?.setOnClickListener {
            (activity as CreateLocationActivity).button1Checked = checkboxButton1!!.isChecked
...
//                Log.d("logggg", "button1 unclicked + ${txtEditTextBodyBody.isFocusable}  ${txtEditTextBodyBodyLink.isClickable}")
        ...
        checkboxButton11?.setOnClickListener {
            (activity as CreateLocationActivity).button2Checked = checkboxButton11.isChecked
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == REQUEST_IMAGE_CAPTURE && resultCode == RESULT_OK) {
            if (photoURI != null) {
                ...
                (activity as CreateLocationActivity).imageBitmap = imageBitmap
                (activity as CreateLocationActivity).imageURL = null
        ...
        if (requestCode === GET_GALLERY_IMAGE && resultCode === RESULT_OK && attr.data != null && data != null) {
            ...
            (activity as CreateLocationActivity).imageBitmap = null
            (activity as CreateLocationActivity).imageURL = selectedImageUri
